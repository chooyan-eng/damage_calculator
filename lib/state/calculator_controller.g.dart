...
_$_CalculatorState _$_$_CalculatorStateFromJson(Map<String, dynamic> json) {
  return _$_CalculatorState(
    ...
    atk: StatusParams.fromJson(json['atk'] as Map<String, dynamic>),
    def: StatusParams.fromJson(json['def'] as Map<String, dynamic>),
    power: json['power'] as int? ?? 100,
    maxDamage: json['maxDamage'] as int? ?? 0,
    minDamage: json['minDamage'] as int? ?? 0,
    atkScaleFactorList: (json['atkScaleFactorList'] as List<dynamic>?)
            ?.map((e) => DamageScaleFactor.fromJson(e as Map<String, dynamic>))
            .toList() ??
        [],
    defScaleFactorList: (json['defScaleFactorList'] as List<dynamic>?)
            ?.map((e) => DamageScaleFactor.fromJson(e as Map<String, dynamic>))
            .toList() ??
        [],
    atkRank:
    ...
    hp: StatusParams.fromJson(json['hp'] as Map<String, dynamic>),
  );
}
